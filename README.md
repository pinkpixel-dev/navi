...
- **Organize and personalize your chats.** Delete, rename, pin, and archive conversations, group them into projects, and search across titles and message content. Settings also supports custom avatars, a saved display name, a short bio, and custom instructions that get added to model context.
